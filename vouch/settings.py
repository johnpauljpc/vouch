...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Vouch API',
    'DESCRIPTION': 'E‑Commerce Receipt Generator - an application focused on automatically generating professional digital receipts after a successful order is placed on an e‑commerce platform.',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    # OTHER SETTINGS
    # 'SERVERS': [ {'url': '/', 'description': 'Base server'}, ],
...
DEFAULT_FROM_EMAIL = "Vouch <onboarding@resend.dev>"
